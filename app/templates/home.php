            ...
            <div>
                ...
                <div class="mt-6">
                    ...
                    <form name="information" id="information">
                        <div class="my-10" id="response"></div>
                        ...
                        <div class="py-2">
                            ...
                            <input name="picture" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="picture" type="file">
...
<script src="app/assets/js/customer-information.js" type="module"></script>